  ...
  render(){
    return (
      <div className ="Register">
        ...
        <Input  style={{display:'flex', padding:'10px'}} placeholder="Type in Password" type="password" name="password" onChange = {this.props.handleChange}></Input>
        <Input style={{display:'flex', padding:'10px'}} placeholder="Confirm Password" type="password" name="confirmPassword" onChange = {this.props.handleChange}></Input>
